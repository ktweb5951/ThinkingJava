...
public class MusicView {
	...
	public void startProgram() {
		...
		int index = -1;
			...
			case 2:
				...
				break;
			case 3:
				singer = inputSinger("삭제");
				index = mController.findIndexBySinger(singer);
				if (index != -1) {
					mController.deletMusic(index);
				}
				break;
			case 4:
				// findListBySinger
				// printAllMusics
				singer = inputSinger("검색");
				mList = mController.findListeBySinger(singer);
	...
	private String inputSinger(String category) {
		Scanner sc = new Scanner(System.in);
		System.out.print(category + "할 가수명 입력 : ");
		String singer = sc.nextLine();
		return singer;
	}
